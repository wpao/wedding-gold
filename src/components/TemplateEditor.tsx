...
const TemplateEditor: React.FC = () => {
  ...
  // Otomatis ambil data berdasarkan URL
  useEffect(() => {
    const url = new URL(window.location.href);
    const idTemplate = url.searchParams.get("idTemplate");
    ...
    if (idTemplate && idPeople) {
      ...
      axiosInstance
        ...
        .catch(() => {
          setData({ ...defaultData, idPeople, idTemplate });
          setMode("tambah");
        });
    }
  }, []);
